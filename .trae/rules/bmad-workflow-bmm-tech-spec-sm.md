# tech-spec-sm Workflow Rule

This rule defines the tech-spec-sm workflow.
...
Reference this workflow with `@workflow-tech-spec-sm` to execute the guided workflow.
