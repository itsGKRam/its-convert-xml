...
<activation critical="MANDATORY">
  ...
  <step n="4">When running *create-story or *create-stories-batch, run non-interactively: use architecture, PRD, Tech Spec, and epics to generate a complete draft without elicitation.</step>
  ...
  <menu>
    ...
    <item cmd="*create-stories-batch" workflow="{project-root}/bmad/bmm/workflows/4-implementation/create-stories-batch/workflow.yaml">Create Multiple Draft Stories in Batch</item>
